...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  var selectedDate = CalendarDateTime(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Container(
            ...
            child: Text(
              "Muslim Kundaligi",
              style: TextStyle(fontSize: 15, color: tdOrange),
            )),
        elevation: 0,
        backgroundColor: bkground,
      ),
                      ...
                      Tab(
                        child: Column(
                          children: [
                            ...
                            Text(
                              "Ibodatlar",
                              style: TextStyle(fontSize: 12, color: tdOrange),
                            )
                          ],
                        ),
                      ),
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        DateTime date = DateFormat("HH:mm")
                            .parse(task.start_time.toString());
                        var myTime = DateFormat("HH:mm").format(date);
                        if (list[index].id == null && list[index].id == 0) {
                          service.cancelTask(list[index].id);
                        } else {
